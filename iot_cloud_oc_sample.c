...
#define CONFIG_WIFI_SSID "saymyname" // 修改为自己的WiFi 热点账号
...
#define CONFIG_APP_DEVICEID "6531f19d1418363e9c5c7eef_566_bearpi" // 替换为注册设备后生成的deviceid

#define CONFIG_APP_DEVICEPWD "9dde2aa5e47af57440759699f8caecce" // 替换为注册设备后生成的密钥
